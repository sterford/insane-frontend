<template>
    <div class="flex flex-col gap-y-4 ml-16 my-10">
        <h1 class="custom-gradient-text-title text-3xl mb-4">Insane Tariffs:</h1>
...
const plans = computed(() => [
    ...
    { sub_type: 'YEAR', price: 369, name: t('pricing.year') },
    { sub_type: 'LIFETIME', price: 449, name: t('pricing.lifetime') },
]);
