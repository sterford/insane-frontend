...
const messages = {
  'en-US': {
    ...
    faq: {
      ...
      q1: 'How to launch Insane Client Software after Purchase?',
      a1: 'After purchasing a subscription, download the installer from your profile and run it. The program will be installed on your computer, and "Insane Client" will appear in your applications list. Use it to launch our software.',
      ...
      a3: 'Your profile information is updated automatically. You do not need to do anything. We advise you not to forcefully turn off Insane Client (alt + f4) as information about the session may not be saved.',
    ...
    privacy: {
      ...
      section1: {
        ...
        text: 'Welcome to Insane Client ("we," "our," or "us"). We are committed to protecting your privacy and ensuring a safe online experience for all our users. This Privacy Policy outlines how we collect, use, and protect your personal information when you interact with our website and services.',
      },
      section2: {
    ...
    rules: {
      ...
      section1: {
        ...
        text: 'Users of Insane Client are prohibited from:',
      ...
      section3: {
        title: '3. Compliance',
        text: 'By using Insane Client, you agree to comply with these rules and any other policies or guidelines provided by us.',
      },
      section4: {
    ...
    terms: {
      ...
      section1: {
        title: '1. Introduction',
        text: 'These Terms of Service ("Terms") govern your use of the Insane Client website and services ("Services"). By accessing or using our Services, you agree to be bound by these Terms.',
      },
      section2: {
      ...
      section4: {
        ...
        text: 'All content and materials available on our website, including but not limited to text, graphics, logos, and software, are the property of Insane Client or our licensors and are protected by intellectual property laws.',
      },
      section5: {
      ...
      section6: {
        ...
        text: 'To the maximum extent permitted by law, Insane Client will not be liable for any indirect, incidental, or consequential damages arising out of or in connection with your use of our Services.',
      },
      section7: {
        title: '7. Termination',
  ...
  'ru-RU': {
    ...
    adventages: {
      title: 'О нас',
      title2: 'Почему Insane Client?',
      first: {
        name: 'Функционал',
        text: 'Insane DLC имеет огромный функционал начиная от киллауры, заканчивая мувмент и рендер модулями!'
      },
      second: {
        name: 'Хранилище',
    ...
    faq: {
      ...
      q1: 'Как запустить Insane Client после покупки?',
      a1: 'После покупки подписки загрузите установщик из вашего профиля и запустите его. Программа будет установлена на ваш компьютер, и "Insane Client" появится в списке приложений. Используйте его для запуска нашего ПО.',
      ...
      a3: 'Информация в вашем профиле обновляется автоматически. Вам не нужно ничего делать. Мы советуем не завершать работу Insane Client принудительно (alt + f4), так как информация о сессии может не сохраниться.',
    ...
    privacy: {
      ...
      section1: {
        title: '1. Введение',
        text: 'Добро пожаловать в Insane Client ("мы", "наш" или "нас"). Мы стремимся защитить вашу конфиденциальность и обеспечить безопасный онлайн-опыт для всех наших пользователей. В данной Политике конфиденциальности описывается, как мы собираем, используем и защищаем вашу личную информацию при взаимодействии с нашим сайтом и услугами.',
      },
      section2: {
    ...
    rules: {
      ...
      section1: {
        ...
        text: 'Пользователям Insane Client запрещается:',
      ...
      section3: {
        title: '3. Соблюдение',
        text: 'Используя Insane Client, вы соглашаетесь соблюдать эти правила и любые другие политики или рекомендации, предоставленные нами.',
      },
      section4: {
    ...
    terms: {
      ...
      section1: {
        title: '1. Введение',
        text: 'Эти Условия использования ("Условия") регулируют ваше использование веб-сайта и услуг Insane Client ("Услуги"). Доступ к нашим Услугам или их использование означает, что вы соглашаетесь соблюдать эти Условия.',
      },
      section2: {
      ...
      section4: {
        ...
        text: 'Все контенты и материалы, доступные на нашем веб-сайте, включая, но не ограничиваясь текстом, графикой, логотипами и программным обеспечением, являются собственностью Insane Client или наших лицензиаров и защищены законами об интеллектуальной собственности.',
      },
      section5: {
      ...
      section6: {
        ...
        text: 'В максимальной степени, разрешенной законом, Insane Client не несет ответственности за любые косвенные, случайные или сопутствующие убытки, возникающие из-за или в связи с использованием вами наших Услуг.',
      },
      section7: {
        title: '7. Прекращение',
...
const savedLanguage = localStorage.getItem('userLanguage') || 'ru-RU';
